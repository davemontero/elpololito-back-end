...
publication_profession = db.Table('publication_profession', 
    db.Column('fk_publication_id', db.Integer, db.ForeignKey('publication.publication_id')), 
...
class Publication(db.Model):
    ...
    profession          = db.relationship('Professions', secondary=publication_profession, back_populates='professional')
...
class Professions(db.Model):
    ...
    professional = db.relationship('Publication', secondary=publication_profession, back_populates='profession')
